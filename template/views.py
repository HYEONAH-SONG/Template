...
class TemplateDetails(APIView):
	...
	def put(self, request, id):
		...
		cloudstack_instance = dict([("name","cloudstack-instance"),("service_offering","Small Instance"),("network_id","5a72a038-2851-4c29-8c36-13b7e29c48da"),("zone","zone1"),("template","centos 7")])
		openstack_instance = dict([("name","openstack-instance"),("image_name","centos 7"),("network",dict([("name","public")])),("flavor_name","m1.nano")])
		cloudstack_volume = dict([("name","volume_1"),("size",3),("zone","zone1")])
		openstack_volume = dict([("name","volume_1"),("region","RegionOne"),("size",3)])
		cloudstack_network = dict([("name","network_1"),("cidr","10.0.0.0/16"),("network_offering","Default Network"),("zone","zone1")])
...
class Terraform(APIView):
	...
	def get(self,request,id):
		...
		serializer = TemplateSerializer(templates)
		# read file
		with open('/home/ubuntu/Template-Manager'+serializer.data['upload_files'],"r") as f:
			json_data = json.load(f)
